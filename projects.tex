...
The programming contest for the next semester is organized by a fellow student and myself. 
...
I created a joystick interface for generic joysticks in C and implemented a sample program for the programming contest at section \ref{agar} - \glqq\nameref{agar}\grqq.
\newline
